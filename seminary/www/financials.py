...
def get_context(context):
    ...
    context.scholarships = frappe.get_all("Payers Fee Category PE", filters={"stu_link": context.student, "pf_active": 1}, fields=["scholarship"])
    context.scholarship = context.scholarships[0]["scholarship"] if context.scholarships else 'You have no scholarship'
    context.invoices = []
    if context.student:
