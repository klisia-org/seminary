<template>
	<div class="development-plan-panel">
		...
		<div v-else :class="embedded ? '' : 'px-3 py-4 sm:px-5'">
			<div class="max-w-3xl">
				<h1 v-if="!embedded" class="text-2xl font-bold text-ink-gray-9">
...
// (ADR 079 decision 2). `student` opens a mentor's view of one student's plan,
// which the server honours only for staff.
...
const mentorMode = computed(() => !!props.student && !!plan.data?.viewer_is_staff)
