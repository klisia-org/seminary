...
<script setup>
import { createResource, Button, Dropdown, toast } from 'frappe-ui'
...
if (!socket) {
	console.error('Socket connection not initialized in DiscussionReplies.vue.');
} else {
	console.log('Socket connection initialized in DiscussionReplies.vue:', socket);
...
console.log('DiscussionReplies props:', props) // Debugging: Check if props are received correctly
onMounted(() => {
