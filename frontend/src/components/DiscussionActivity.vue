...
//     auto: false,
//     onSuccess(data) {
//         console.log('Student data inside student:', data);
//     },
//     onError(error) {
//         console.warn('User is not a student', error);
//         // Set default data for non-students
//     },
// });
...
console.log('Has Saved Submission:', hasSavedSubmission.value)
...
// const reloadDiscussionLists = () => {
// 	const courseName = router.currentRoute.value.params.courseName
// 	const discussionID = props.discussionID
// 	const owner = user.data?.name
// 	if (!courseName || !discussionID || !owner) {
// 		return
// 	}

// 	all_discussions.reload({
// 		course_name: courseName,
// 		discussion_id: discussionID,
// 	})

// 	savedsubmission.reload({
// 		course_name: courseName,
// 		discussion_id: discussionID,
// 		owner,
// 	})
...
//     if (!courseName || !discussionID || !owner) {
//         console.warn("Missing required data:", { courseName, discussionID, owner })
//         return
//     }
...
// watch(
// 	() => [router.currentRoute.value.params.courseName, props.discussionID],
// 	() => {
// 		reloadDiscussionLists()
// 	},
// 	{ immediate: true }
...
// )
// watch(
//   () => [user.data?.name, props.discussionID],
//   ([owner, discussionID]) => {
//     if (owner && discussionID) {
//       reloadDiscussionLists()
//     }
//   },
//   { immediate: true }
