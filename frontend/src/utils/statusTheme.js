...
const RED = new Set(['fail', 'failed', 'overdue', 'rejected', 'unseated'])
const ORANGE = new Set(['withdrawn', 'draft', 'pending', 'unpaid', 'not started', 'awaiting payment', 'revisions required', 'waitlisted'])
