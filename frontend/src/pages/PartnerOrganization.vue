...
import { Breadcrumbs, createResource, Badge } from 'frappe-ui'
import { MapPin, Globe, Mail, Briefcase } from 'lucide-vue-next'
...
const breadcrumbs = computed(() => [
	{ label: __('Organizations'), route: { name: 'PartnerOrganizationList' } },
