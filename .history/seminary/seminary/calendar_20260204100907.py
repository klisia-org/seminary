...
def course_ics(course_schedule=None, token: str | None = None):
    ...
    # Return plain text ICS data
    frappe.response["type"] = "text/calendar"
    frappe.response["filename"] = f"{course_schedule}.ics"
    frappe.response["body"] = calendar_data
