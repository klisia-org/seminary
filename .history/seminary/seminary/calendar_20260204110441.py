...
def course_ics(course_schedule=None, token=None):
    ...
    for meeting in meeting_dates:
        ...
        event.created = convert_to_ics_datetime(creation_datetime.astimezone(pytz.UTC))
    ...
    for assignment in assignments:
        ...
        event.created = convert_to_ics_datetime(
            frappe.utils.get_datetime(assignment.creation).astimezone(pytz.UTC)
        )
        calendar.events.add(event)
