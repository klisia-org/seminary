...
class CourseEnrollmentIndividual(Document):
    ...
    def validate_duplicate_course(self):
        ...
        if CEI:
            frappe.throw(
                _("Student already enrolled in {0} for credit. If students should be able to enroll again, please adjust the program course settings to make it repeatable.").format(
