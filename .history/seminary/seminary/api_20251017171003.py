...
@frappe.whitelist()
def get_user_discussion_replies(course_name: str | None = None, discussion_id: str | None = None, member: str | None = None):
	replies = frappe.db.sql("""
		...
		order by r.creation asc""", (course_name, discussion_id, member), as_dict=1)
	return replies
