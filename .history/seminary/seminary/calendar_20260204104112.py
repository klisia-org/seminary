...
def course_ics(course_schedule=None, token=None):
    ...
    currentdt = event.dtstamp = datetime.now(pytz.UTC)
    print("Current dt: ", currentdt)
    converteddt = convert_to_ics_datetime(currentdt)
    print("Converted dt: ", converteddt)
    calendar = Calendar()
    ...
    for assignment in assignments:
        ...
        event.dtstamp = convert_to_ics_datetime(currentdt)
        calendar.events.add(event)
