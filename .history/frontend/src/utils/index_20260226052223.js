...
export function getEditorTools() {
	return {
		...
		assignment: { class: Assignment, config: { course: course} },
		quiz: { class: Quiz, config: { course: course} },
		exam: { class: Exam, config: { course: course} },
		discussionActivity: { class: DiscussionActivity, config: { course: course} },
		upload: { class: Upload, config: { course: course} },
		markdown: {
			class: Markdown,
			inlineToolbar: true,
		},
