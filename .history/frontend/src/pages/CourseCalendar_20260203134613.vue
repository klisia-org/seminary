...
const subscribeCourseCalendar = () => {
    const calendarUrl = `${window.location.origin}/api/method/seminary.calendar.get_course_schedule_ics?course=${props.courseName}&token=${course.data.calendar_token}`;
