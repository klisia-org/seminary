<template>
  ...
  <div class="flex items-center justify-between mb-5">
    ...
    <div class="w-1/3 mt-5">
      ...
      <input type="text" id="examTitle" :value="ExamTitle.data" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" disabled />
