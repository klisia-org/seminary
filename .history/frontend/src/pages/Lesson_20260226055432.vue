...
const renderEditor = (holder, content) => {
	...
	const course = lesson?.data?.course_title
...
/* Contain the folder widget's stacking context */
#editor [data-v-app],
.ProseMirror [data-v-app] {
	position: relative;
	z-index: 0;
	isolation: isolate;
}

/* Contain the entire editor area */
#editor {
	position: relative;
	z-index: 0;
	isolation: isolate;
...
/* Contain the grid layout */
.grid.h-screen {
	isolation: isolate;
	z-index: 0;
}

/* Dialog must be above everything */
