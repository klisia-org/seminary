	...
	<div v-if="lesson.data" class="">
		...
		<div class="grid md:grid-cols-[70%,30%] h-screen">
			<div class="border-r container pt-5 pb-10 px-5">
				...
				<div class="mt-20">
					<Discussions v-if="allowDiscussions && lesson.data?.name" :title="__('Questions in Lesson')"
						:doctype="'Course Lesson'" :docname="lesson.data.name" :key="lesson.data.name" type="single" />
				</div>
			</div>
