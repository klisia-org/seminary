    ...
    <template #default>
      <div class="flex space-x-6 overflow-hidden h-[calc(100vh-7.2rem)]">
        ...
        <div class="w-1/3 border-l pl-4">
          ...
          <!-- Comments TextEditor -->
          <div class="mt-20">
            <Discussions :title="'Comments on Discussion Activity Submission by ' + studentName"
              :doctype="'Discussion Submission'" :docname="currentSubmission" :key="currentSubmission" />
          </div>
        </div>
      </div>
    </template>
...
<script setup>
import { Breadcrumbs, createResource, createDocumentResource, Button } from 'frappe-ui'
...
const submissionDoc = createDocumentResource({
  doctype: 'Discussion Submission',
