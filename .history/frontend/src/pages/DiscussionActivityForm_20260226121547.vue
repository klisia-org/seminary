<template>
	...
	<div class="w-3/4 mx-auto py-5">
		...
		<div class="mb-8">
			...
			<RichTextInput :content="discussion.prompt" @change="(val) => discussion.prompt = val"
				:placeholder="__('Enter a prompt for the discussion.')" :editable="true" :id="'new-discussion'" />
		</div>
	</div>
    ...
    let crumbs = [
        {
            ...
            route: { name: 'DiscussionActivities' },  // or wherever the list page is
        },
    ]
    crumbs.push({
        ...
        route: props.discussionID === 'new'
            ? { path: '/discussion-activity/new' }
            : { name: 'DiscussionActivityForm', params: { discussionID: props.discussionID } },
    })
    return crumbs
})
