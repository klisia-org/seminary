<template>
	...
	<div class="w-3/4 mx-auto py-5">
		...
		<div class="mb-8">
			...
			<RichTextInput v-if="props.discussionID === 'new' || discussionDetails.data"
				:key="discussionDetails.data?.name || 'new'" v-model="discussion.prompt"
...
const discussionDetails = createResource({
	...
	auto: false,
	onSuccess(data) {
		console.log('Discussion data loaded, prompt:', data.prompt) // Debug
