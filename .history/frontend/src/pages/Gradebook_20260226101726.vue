...
<div v-else class="overflow-x-auto mx-2 sm:mx-5">
    <table class="min-w-full border-collapse border border-gray-300">
        <thead>
            ...
            <!-- Weight Row -->
            <tr>
                <td class="sticky left-0 z-10 border border-gray-300 bg-gray-50 px-2 py-1 sm:px-4 text-xs text-gray-500 font-medium">
                    {{ __('Weight') }}
                </td>
                <td
                    v-for="assessment in sortedAssessments"
                    :key="'weight-' + assessment.assessment_criteria"
            ...
            >
                ...
                <td class="sticky left-0 z-10 border border-gray-300 bg-white px-2 py-2 sm:px-4">
                    <div class="flex items-center justify-between gap-1">
                        ...
                        <Tooltip
                            :text="`${__('Send Email to')} ${student.stuname_roster}`"
                            placement="bottom"
                            arrow-class="fill-surface-white"
                        >
                            <a
                                :href="`mailto:${student.stuemail_rc}`"
