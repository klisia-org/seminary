<template>
  <div v-if="course.data && instructors.data">
    ...
    <h2 class="text-l mb-12 ml-5">{{ __('Student Groups are used to assign students to specific groups within' +
      ' the course, both for assigning grading to specific instructors and for organizing collaborative work.') }}</h2>
