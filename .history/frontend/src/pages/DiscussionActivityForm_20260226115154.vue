<template>
	...
	<div class="w-3/4 mx-auto py-5">
		...
		<div class="mb-8">
			...
			<RichTextInput v-model="discussion.prompt" :placeholder="__('Enter a prompt for the discussion.')" :editable="true" :fixed-menu="true" />
				:placeholder="__('Enter a prompt for the discussion.')" :editable="true" :fixed-menu="true"
