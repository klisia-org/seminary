...
const renderEditor = (holder, course = null) => {
	...
	console.log('renderEditor called with course:', course)
	return new EditorJS({
		holder: holder,
...
const lessonDetails = createResource({
	...
	onSuccess(data) {
		...
		editor.value = renderEditor('content', course)
		console.log('LessonForm: Editor rendered with course:', course) // Debugging log
		instructorEditor.value = renderEditor('instructor-notes', course)
