...
<tr>
    ...
    >
        <div class="flex flex-col items-center gap-0.5">
            <router-link
                v-if="assessment.type === 'Exam' && assessment.exam"
            ...
            <router-link
                v-else-if="assessment.type === 'Assignment' && assessment.assignment"
            ...
            <router-link
                v-else-if="assessment.type === 'Quiz' && assessment.quiz"
            ...
            <router-link
                v-else-if="assessment.type === 'Discussion' && assessment.discussion"
