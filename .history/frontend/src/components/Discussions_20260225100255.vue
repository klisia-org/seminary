<template>
	...
	<div v-if="props.type === 'single' && !loading">
		...
		<DiscussionReplies v-if="currentTopic.value" :topic="currentTopic.value" v-model:showTopics="showTopics" />
	</div>
	<div v-if="topics.data?.length && !singleThread && props.type === 'multi'">
