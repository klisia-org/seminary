			...
			<div class="open-question-dialog space-y-4 max-h-[70vh] overflow-y-auto">
				...
				<div v-if="questionType == 'new' || editMode" class="space-y-2">
					<div>
						...
						<RichTextInput :id="'question-' + (currentQuestion.name || 'new')"
					...
					<div>
						...
						<RichTextInput :id="'explanation-' + (currentQuestion.name || 'new')"
							:content="question.explanation || ''" @change="(val) => (question.explanation = val)" :editable="true" />
					</div>
