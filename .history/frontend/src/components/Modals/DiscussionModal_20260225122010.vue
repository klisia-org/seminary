<template>
	<Dialog ref="dialogRef" v-model="show" :disableOutsideClickToClose="true" :options="dialogOptions"
		@after-open="onDialogOpen">
...
<script setup>
import { Dialog, FormControl, createResource, toast, TextEditor } from 'frappe-ui'
