		...
		<div class="border-r p-5 overflow-y-auto h-[calc(100vh-3.2rem)]">
			...
			<div v-if="canGradeSubmission" class="mt-8 space-y-4">
				...
				<div>
					...
					<textarea v-model="comments" @input="isDirty = true" class="prose-sm max-w-none border border-outline-gray-3 bg-surface-gray-2 rounded-md py-2 px-3 min-h-[7rem] w-full focus:outline-none"></textarea>
				</div>
			</div>
