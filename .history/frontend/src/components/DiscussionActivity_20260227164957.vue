<template>
    ...
    <div v-else-if="discussion.loading" class="p-5 text-center text-gray-500">
...
const submissionResource = createDocumentResource({
	doctype: 'Discussion Submission',
	name: props.submissionName !== 'new' ? props.submissionName : null,
	auto: props.submissionName !== 'new',
	onError(err) {
		toast.error(err.messages?.[0] || err)
	},
})
