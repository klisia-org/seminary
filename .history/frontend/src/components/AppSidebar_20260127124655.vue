		...
		<div class="flex flex-col overflow-hidden">
			...
			<nav class="flex flex-col gap-1 overflow-y-auto px-3 pb-6">
				...
				<template v-if="user.data?.is_moderator">
					<SidebarLink :label="'Desk'" :to="'/app'" :isCollapsed="isSidebarCollapsed" />
				</template>
			</nav>
		</div>
		<div class="px-3 pb-6">
...
import { GraduationCap, Banknote, ArrowLeftToLine, ArrowRightToLine, BookOpen, Mon } from 'lucide-vue-next';
