<template>
	<DiscussionActivity v-if="user.data" :discussionID="discussionID" :courseName="props.courseName" :submissionName="submission.data?.name || 'new'"/>
...
onMounted(() => {
console.log('Discussion ID and course Name in Block: ', props.discussionID, props.courseName)
})
