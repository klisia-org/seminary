...
| ------------------ | -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Level**          | `Nivel de programa`                          | The tier (Certificate, Bachelor, Master, Doctorate, Continuing Ed…) and whether the program is _ongoing_.          |
| **Has an end?**    | _(mirrored)_ `Is Ongoing` | Degree-style (graduation, GPA, transcript) vs. ongoing (no end, no graduation). |
| **Progress model** | `Tipo de inscripción`                        | Measured by **terms** completed (Time-based) or **credits** earned (Credits-based).             |
