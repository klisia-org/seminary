...
**Scholarships** module separates the *policy* (a reusable scholarship you
offer) from the *grant* (one student's award on one enrollment), computes the
...
(*Effective From* / *Effective To*); the discount only applies while today falls
inside it.
...
*and* a scholarship's **Show on Portal** is ticked, an eligible student sees it
