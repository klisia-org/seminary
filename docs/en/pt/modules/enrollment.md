...
Se uma nota de crédito é criada após o CEI ser enviado e a porcentagem paga recalculada cair abaixo do limite, o CEI **permanece em Enviado** — o aluno não será silenciosamente des-inscrito no meio do período letivo. Instead, a ToDo is created and an email is sent to all Academics Users so the registrar can decide whether to file a Withdrawal Request, follow up for collection, or accept the new reality.
