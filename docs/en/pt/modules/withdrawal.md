...
Os estudantes também podem criar solicitações de trancamento para outras disciplinas, além desta, selecionando a opção apropriada em "Escopo do Trancamento". Each course will track its own Withdrawal Request, but seminary administrators will see the related requests.
